  ...
  <!--___________________request book__________________-->
	<div class="srch">
		<form class="navbar-form" method="post" name="form1">
				...
				<button style="background-color: #6db6b9e6;" type="submit" name="submit1" class="btn btn-default">Request book
				</button>
		</form>
	</div>
  ...
  <?php
    ...
    /*if button is not pressed.*/
      ...
      if(isset($_POST['submit1']))
      {
        if(isset($_SESSION['login_user']))
        {
          mysqli_query($db,"INSERT INTO imprumut2 Values('$_SESSION[login_user]', '$_POST[id_carte]', '', '', '');");
          ?>
