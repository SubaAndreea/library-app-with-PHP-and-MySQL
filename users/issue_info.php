...
<div class="container">
            ...
            <?php
                ...
                if(isset($_SESSION['login_user']))
                {
                    $sql="SELECT cititor.username,id_cititor, carte.id_carte,titlul_cartii,autor_carte,editura,categorie, 
                          imprumut2.data_imprumut,imprumut2.data_returnarii 
                          FROM `cititor` INNER JOIN `imprumut2` ON cititor.username=imprumut2.username INNER JOIN carte ON imprumut2.id_carte=carte.id_carte 
                          WHERE imprumut2.username='$_SESSION[login_user]' AND imprumut2.aprobare != '' ORDER BY `imprumut2`.`data_returnarii` ASC";
