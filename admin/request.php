...
<body>
    ...
    <div class="container">
        ...
        <h2 style="text-align: center;">Request Books</h2>    
        <?php
            if(isset($_SESSION['login_user']))
            {
                $sql= "SELECT cititor.username,id_cititor, carte.id_carte,titlul_cartii,autor_carte,editura,categorie FROM `cititor` INNER JOIN `imprumut2` ON cititor.username=imprumut2.username INNER JOIN carte ON imprumut2.id_carte=carte.id_carte WHERE imprumut2.aprobare=''";
