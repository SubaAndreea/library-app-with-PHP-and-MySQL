  ...
  <body>
        ...
        <div class="registration_img">
            <div class="box2">
                ...
                <form  name="Registration" action="" method="post">
                    <br>
                    <div class="login">
                      <!--<input class="form-control" type="text" name="id_admin" placeholder="Id" required=""> <br>-->
                      <input class="form-control" type="text" name="nume_admin" placeholder="Nume" required=""> <br>
                      <input class="form-control" type="text" name="prenume_admin" placeholder="Prenume" required=""> <br>
    ...
    <?php
      if(isset($_POST['submit']))
      {
        ...
        if($count==0)
        {
        mysqli_query($db,"INSERT INTO `ADMIN` VALUES('', '$_POST[nume_admin]', '$_POST[prenume_admin]', '$_POST[adresa]', '$_POST[nr_telefon]', '$_POST[adresa_de_email]', '$_POST[username]', '$_POST[password]', 'p.jpg');");
    ?>
