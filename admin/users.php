...
<body>
  ...
  <h2 style="font-size: 30px; font-weight: bold;">List Of Users</h2>
  <?php
    if(isset($_POST['submit']))
    {
      $q=mysqli_query($db,"SELECT id_cititor, nume_cititor, prenume_cititor, adresa, nr_telefon, adresa_de_email, username FROM `cititor` WHERE username like '%$_POST[search]%' ");
      ...
      while($row=mysqli_fetch_assoc($q))
			{
				echo "<tr>";
                    echo "<td>"; echo $row['nume_cititor']; echo "</td>";
                    echo "<td>"; echo $row['prenume_cititor']; echo "</td>";
                    echo "<td>"; echo $row['adresa']; echo "</td>";
                    echo "<td>"; echo $row['nr_telefon']; echo "</td>";
                    echo "<td>"; echo $row['adresa_de_email']; echo "</td>";
    ...
    /*if button is not pressed*/
		...
		{
            $res=mysqli_query($db,"SELECT id_cititor, nume_cititor, prenume_cititor, adresa, nr_telefon, adresa_de_email, username FROM `cititor`;");
