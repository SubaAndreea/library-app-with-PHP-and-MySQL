    ...
    <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; open</span>
        ...
        <div class="container">
            ...
            <?php
                ...
                if(isset($_SESSION['login_user']))
                {
                    $sql="SELECT cititor.username,id_cititor, carte.id_carte,titlul_cartii,autor_carte,editura,categorie, imprumut2.data_imprumut,imprumut2.data_returnarii FROM `cititor` INNER JOIN `imprumut2` ON cititor.username=imprumut2.username INNER JOIN carte ON imprumut2.id_carte=carte.id_carte 
                          WHERE imprumut2.aprobare='Yes' ORDER BY `imprumut2`.`data_returnarii` ASC";
                    ...
                    {
                        $d=date("Y-m-d");
                        if($d > $row['data_returnarii'])
                        {
                            $c=$c+1;
                            $var='<p style="color:yellow; background-color:red;">EXPIRED</p>';
                            mysqli_query($db,"UPDATE imprumut2 SET aprobare='$var' where `data_returnarii`='$row[data_returnarii]' and aprobare='Yes' limit $c;");
                            echo $d."</br>";
                        }
                        echo "<tr>";
